...
import com.nuvei.addon.constants.NuveiaddonConstants;



/**
 * This is the extension manager of the Nuveiaddon extension.
 */
public class NuveiaddonManager extends GeneratedNuveiaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(NuveiaddonManager.class.getName());
	 ...
	 */
	public static NuveiaddonManager getInstance()
	{
		return (NuveiaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				NuveiaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public NuveiaddonManager() 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of NuveiaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of NuveiaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of NuveiaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
