package com.nuvei.test.inbound.events;
...
public class NuveiCronJobPersistenceHook implements PrePersistHook {
    private final CronJobService cronJobService;

    public NuveiCronJobPersistenceHook(final CronJobService cronJobService) {
