...
public class NuveiTriggerEventOrderProcessCapturedStrategyTest {
    ...
    @InjectMocks
    private NuveiTriggerEventOrderProcessCapturedStrategy testObj;
    ...
    @Test
    public void isApplicable_shouldReturnTrue_whenSourceIsEqualsToCAPTURE() {
    ...
    @Test
    public void isApplicable_shouldReturnFalse_whenSourceIsDifferentToCAPTURE() {
    ...
    @Test
    public void execute_shouldReturnTrue_WhenBusinessProcessIsFoundInWaitForCaptureStatusAndEventIsTriggered() {
        paymentTransactionEntryModelStub.setType(PaymentTransactionType.CAPTURE);
    ...
    @Test
    public void execute_shouldReturnTrue_WhenBusinessProcessIsFoundInWaitForManualCheckStatusAndEventIsTriggered() {
        paymentTransactionEntryModelStub.setType(PaymentTransactionType.CAPTURE);
        when(processDefinitionDaoMock.findWaitingOrderProcesses(ORDER_CODE, PaymentTransactionType.CAPTURE.getCode())).thenReturn(Collections.emptyList());
        when(processDefinitionDaoMock.findWaitingOrderProcesses(ORDER_CODE, MANUAL_ORDER_CHECK_CSA)).thenReturn(Collections.singletonList(businessProcessModelStub));
    ...
    public void execute_shouldReturnFalse_WhenEventIsNotTriggered() {
        ...
        when(processDefinitionDaoMock.findWaitingOrderProcesses(ORDER_CODE, MANUAL_ORDER_CHECK_CSA)).thenReturn(Collections.emptyList());
