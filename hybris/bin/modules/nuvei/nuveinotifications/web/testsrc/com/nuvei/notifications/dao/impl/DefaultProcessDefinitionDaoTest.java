...
import static com.nuvei.notifications.dao.impl.DefaultProcessDefinitionDao.*;
...
public class DefaultProcessDefinitionDaoTest {
    ...
    public void testFindWaitingProcessForTransactionType() throws Exception {
        final List<BusinessProcessModel> result = testObj.findWaitingOrderProcesses(ORDER_CODE, AUTHORIZATION.getCode());
