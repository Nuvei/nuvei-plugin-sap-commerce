...
public class NuveiCancelOrderActionTest {
    ...
    @InjectMocks
    private NuveiCancelOrderAction testObj = new NuveiCancelOrderAction() {
        @Override
    ...
    public void setUp() {
        ...
        when(orderModelMock.getStatus()).thenReturn(OrderStatus.CAPTURE_PENDING);
