package com.nuvei.sampledataaddon.jalo;
...
import com.nuvei.sampledataaddon.constants.NuveisampledataaddonConstants;



/**
 * This is the extension manager of the Nuveisampledataaddon extension.
 */
public class NuveisampledataaddonManager extends GeneratedNuveisampledataaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(NuveisampledataaddonManager.class.getName());
	 ...
	 */
	public static NuveisampledataaddonManager getInstance()
	{
		return (NuveisampledataaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				NuveisampledataaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public NuveisampledataaddonManager() 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of NuveisampledataaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of NuveisampledataaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of NuveisampledataaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
