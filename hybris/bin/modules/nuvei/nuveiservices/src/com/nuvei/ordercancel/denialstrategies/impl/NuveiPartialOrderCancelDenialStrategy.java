 ...
 * order cancel
 */
public class NuveiPartialOrderCancelDenialStrategy extends AbstractCancelDenialStrategy implements OrderCancelDenialStrategy {

    protected static final Logger LOG = LogManager.getLogger(NuveiPartialOrderCancelDenialStrategy.class);
