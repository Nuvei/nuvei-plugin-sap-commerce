 ...
 * of the transactions is not equals to the amount in the order
 */
public class NuveiCheckPaymentStatusForSaleOrCaptureWAITAmountStrategy extends NuveiAbstractActionTransitionStrategy {

    private static final Logger log = LogManager.getLogger(NuveiCheckPaymentStatusForSaleOrCaptureWAITAmountStrategy.class);

    /**
     * Default constructor for {@link NuveiCheckPaymentStatusForSaleOrCaptureWAITAmountStrategy}
     *
     * @param modelService injected
     */
    protected NuveiCheckPaymentStatusForSaleOrCaptureWAITAmountStrategy(final ModelService modelService) {
    ...
    public boolean isApplicable(final OrderModel source) {
        ...
        final PaymentTransactionEntryModel paymentEntryCaptured = Stream.ofNullable(source.getPaymentTransactions())
        ...
        return isValidTransactionStatus(paymentEntryCaptured)
                && !isTransactionPriceSameAsPlacedOrder(source, paymentEntryCaptured);
    }
     ...
     */
    protected boolean isValidTransactionStatus(final PaymentTransactionEntryModel paymentTransactionEntryModel) {
    ...
    /***
     * Returns true if the {@link PaymentTransactionEntryModel} is {@code CAPTURE} or {@code SALE}
     * @param paymentTransactionEntryModel the {@link PaymentTransactionEntryModel}
     * @return Returns true if the {@link PaymentTransactionEntryModel} is {@code CAPTURE} or {@code SALE}
     */
