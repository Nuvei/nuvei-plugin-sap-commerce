 ...
 */
public class NuveiCheckAuthorizeOrderPaymentForSaleOrAuthNOKAmountStrategy extends NuveiAbstractActionTransitionStrategy {

    private static final Logger LOG = LogManager.getLogger(NuveiCheckAuthorizeOrderPaymentForSaleOrAuthNOKAmountStrategy.class);

    /**
     * Default constructor for {@link NuveiCheckAuthorizeOrderPaymentForSaleOrAuthNOKAmountStrategy}
     *
     * @param modelService injected
     */
    protected NuveiCheckAuthorizeOrderPaymentForSaleOrAuthNOKAmountStrategy(final ModelService modelService) {
    ...
    public String execute(final OrderModel source) {
        updateOrderStatus(source, OrderStatus.CHECKED_INVALID);
        return NOK;
    }
    ...
    public boolean isApplicable(final OrderModel source) {
        ...
        return isValidTransactionStatus(paymentEntryAuthorized)
                && !isTransactionPriceSameAsPlacedOrder(source, paymentEntryAuthorized);
    }
