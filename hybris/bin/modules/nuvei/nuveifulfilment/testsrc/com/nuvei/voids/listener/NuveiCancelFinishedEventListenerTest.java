...
public class NuveiCancelFinishedEventListenerTest {
    ...
    @Spy
    @InjectMocks
    private NuveiCancelFinishedEventListener testObj;
    ...
    @Mock
    private NuveiVoidProcessModel checkoutComVoidProcessModelMock;
    @Mock
