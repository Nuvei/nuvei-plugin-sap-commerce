...
public class NuveiFraudStrategyTest {
    ...
    @InjectMocks
    private NuveiFraudStrategy testObj;
    ...
    @Test
    public void isFraudTransaction_shouldReturnTrue_whenTypeIsAUTHORIZATIONAndFinalFraudDecisionIsREJECT() {
        ...
        final boolean result = testObj.isFraudTransaction(paymentTransactionEntryModelStub);

        assertThat(result).isTrue();
    }

    @Test
    public void isFraudTransaction_shouldReturnTrue_whenTypeIsAUTHORIZATIONAndSystemDecisionIsREJECT() {
        paymentTransactionEntryModelStub.setType(PaymentTransactionType.AUTHORIZATION);
        paymentTransactionEntryModelStub.setSystemDecision(SystemDecisionEnum.REJECT);
    ...
    @Test
    public void isFraudTransaction_shouldReturnTrue_whenTypeIsAUTHORIZATIONAndSystemDecisionIsERROR() {
        paymentTransactionEntryModelStub.setType(PaymentTransactionType.AUTHORIZATION);
        paymentTransactionEntryModelStub.setSystemDecision(SystemDecisionEnum.ERROR);
    ...
    @Test
    public void isFraudTransaction_shouldReturnFalse_whenTypeIsAUTHORIZATIONAndFinalFraudDecisionIsACCEPT() {
        paymentTransactionEntryModelStub.setType(PaymentTransactionType.AUTHORIZATION);
    ...
    public void findManualReviewTransaction_shouldReturnPaymentTransactionEntry_whenTypeAndSystemDecisionMatches() {
        ...
        final PaymentTransactionEntryModel result = testObj.findManualReviewTransaction(abstractOrderModelStub);
