...
public class CheckPaymentStatusForSaleOrCaptureWAITAmountStrategyTest {

    private static final String WAIT = "WAIT";

    @InjectMocks
    private NuveiCheckPaymentStatusForSaleOrCaptureWAITAmountStrategy testObj;
    ...
    @Test
    public void execute_shouldReturnTransitionWaitAndEnsureOrderIsSavedWithOrderStatusAsCaptureInvalid() {
        final OrderModel orderMock = Mockito.spy(OrderModel.class);

        final String result = testObj.execute(orderMock);
    ...
    @Parameters(method = "nonValidPaymentTransactionTypesForCaptureWait")
    @Test
    public void isApplicable_shouldReturnFalseWhenStoredPaymentTransactionIsDifferentFromCaptureOrSale(final PaymentTransactionType paymentTransactionType) {
        final OrderModel orderStub = new OrderModel();
    ...
    @Parameters(method = "validPaymentTransactionTypesForCaptureWait")
    @Test
    ...
    protected Object[] nonValidPaymentTransactionTypesForCaptureWait() {
        return new Object[]{
    ...
    protected Object[] validPaymentTransactionTypesForCaptureWait() {
        return new Object[]{
                new Object[]{PaymentTransactionType.CAPTURE, NuveiTransactionStatus.APPROVED, 88.00D, 88.00D, false},
                new Object[]{PaymentTransactionType.CAPTURE, NuveiTransactionStatus.SUCCESS, 88.00D, 88.00D, false},
                new Object[]{PaymentTransactionType.CAPTURE, NuveiTransactionStatus.ERROR, 88.00D, 88.00D, false},
                new Object[]{PaymentTransactionType.CAPTURE, NuveiTransactionStatus.SUCCESS, 88.00D, 55.00D, true},
